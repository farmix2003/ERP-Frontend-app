  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
        <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
            ...
            <button
            onClick={handleClose}
            className="absolute right-4 top-4 rounded-full bg-gray-200 py-1 px-2.5 cursor-pointer font-semibold text-gray-600 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400"
            >
             ✕
            </button>
